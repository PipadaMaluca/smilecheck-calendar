...
const navItems = [
  ...
  { id: 'agenda', label: 'Consulta', icon: Calendar, path: '/triagem' },
  { id: 'saude', label: 'Saúde', icon: Heart, path: '/saude' },
  { id: 'chat', label: 'Chat', icon: MessageCircle, path: '/chat' },
  { id: 'conta', label: 'Conta', icon: Settings, path: '/conta' },
];
            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'text-muted-foreground hover:bg-[#1E3A5F] hover:text-foreground'
              )}
            >
