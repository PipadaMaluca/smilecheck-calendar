...
export function MobileHeader({
  ...
  return (
    <div className="sticky top-0 z-40 bg-background/95 backdrop-blur-sm border-b border-border w-full">
      <div className="relative flex items-center px-4 py-3 w-full max-w-full">
        {/* Menu button - absolute left */}
        <Button
          variant="ghost"
          size="icon"
          onClick={onMenuClick}
          className="absolute left-4 text-muted-foreground hover:text-foreground flex-shrink-0"
        >
