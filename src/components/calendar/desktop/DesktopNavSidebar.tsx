...
export function DesktopNavSidebar({
  ...
  return (
    <aside
      className={cn(
        'h-full bg-card border-r border-border flex flex-col transition-all duration-300 z-30 overflow-hidden',
    ...
    >
      ...
      {/* Navigation Items */}
      <nav className={cn(
        'flex flex-col gap-1 p-2 flex-shrink-0',
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Button
              ...
              className={cn(
                'flex flex-col gap-1 h-auto py-2 transition-all duration-200',
                isExpanded ? 'w-full px-3' : 'w-12 px-0',
                isActive 
      ...
      {isExpanded && (
        <div className="flex-1 flex flex-col overflow-hidden border-t border-border mt-2">
          ...
          <div className="flex-1 overflow-y-auto px-3 pb-3 scrollbar-hide">
            {/* All checkbox */}
            <div
              className="flex items-center gap-2 py-1.5 cursor-pointer hover:bg-secondary/30 rounded px-1.5 -mx-1.5"
              onClick={onSelectAllDentists}
            >
                ...
                {filteredDentists.map((dentist) => {
                  ...
                  return (
                    ...
                    >
                      <Checkbox
                        checked={isSelected}
                        className="border-muted-foreground h-4 w-4 data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                      />
