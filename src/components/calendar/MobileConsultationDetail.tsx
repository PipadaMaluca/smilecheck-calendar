...
import { ArrowLeft, User, Calendar, Clock, MapPin, Video, Star, Phone, Mail, Camera, MessageCircle, FileText, RefreshCw, Copy, X, AlertTriangle, Pill, ChevronDown, ChevronUp } from 'lucide-react';
...
export function MobileConsultationDetail({ consultation, onClose, onNavigate, onCopy, onViewDossier }: MobileConsultationDetailProps) {
        ...
        <div className="bg-card rounded-xl border border-border p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <Button variant="secondary" size="sm" className="gap-2 justify-start" onClick={() => onNavigate('prescrever')}>
              <FileText className="w-4 h-4" /> Prescrever Receita
            </Button>
          </div>
        </div>
      </div>
