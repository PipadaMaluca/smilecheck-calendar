...
export function LoginScreen() {
  ...
  const validate = () => {
    ...
    if (!email.trim()) e.email = 'Email é obrigatório';else
  ...
  return (
    <AuthBackground>
      <div className="flex flex-col items-center animate-fade-in">
        {/* Logo */}
        <img src="/assets/smilecheck-logo-vertical.png" alt="SmileCheck" className="h-[360px] sm:h-[420px] mb-2" />
        <p className="text-muted-foreground mb-8 text-xl">O seu sorriso, a nossa prioridade</p>
