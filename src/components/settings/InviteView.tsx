...
export function InviteView({ onClose }: InviteViewProps) {
          ...
          <CardContent className="pt-4 space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 bg-secondary rounded-lg px-4 py-2.5 text-base font-mono font-bold text-foreground tracking-widest text-center">
                  {code}
                </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <div className="flex-1 bg-secondary rounded-lg px-4 py-2.5 text-sm text-muted-foreground truncate">
                  {link}
                </div>
