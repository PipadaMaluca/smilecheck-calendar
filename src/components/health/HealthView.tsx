...
import { Heart, Droplets, Ruler, Weight, AlertTriangle, Pill, Activity, FileText, ClipboardList, Syringe, X, Plus, Eye, Upload, ChevronLeft, ChevronRight, Check, Send } from 'lucide-react';
