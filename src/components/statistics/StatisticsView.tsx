...
import { Download, Calendar, CheckCircle2, XCircle, Star, TrendingUp, Users } from 'lucide-react';
import { mockConsultations, mockDentists, mockClinics, getDentistsForClinic } from '@/data/mockData';
