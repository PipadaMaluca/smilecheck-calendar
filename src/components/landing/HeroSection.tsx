    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-20 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <img
          ...
          alt="SmileCheck"
          className="logo-light-adapt h-[280px] sm:h-[340px] mx-auto mb-6 animate-fade-in drop-shadow-[0_0_30px_hsla(207,90%,54%,0.4)] object-fill shadow-2xl rounded-3xl border border-primary" />
