...
const PRICE_TIERS = [
  { threshold: 500, label: 'Até 500 pts' },
  { threshold: 2000, label: '500 — 2 000 pts' },
  { threshold: Infinity, label: 'Mais de 2 000 pts' },
];
          ...
          <div key={product.id}>
            ...
            <button
              ...
              className={cn(
                ...
                canAfford
                  ? 'cursor-pointer hover:bg-accent/60 hover:shadow-md hover:border-primary/30'
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-muted-foreground truncate">
                  {product.category}
                  {product.discount && (
                    <span className="ml-2 text-amber-400 font-medium">{product.discount} desconto</span>
                  )}
                </p>
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                >
                  {canAfford ? 'Resgatar' : `Faltam ${missing.toLocaleString()}`}
                </span>
              </div>
            </button>
          </div>
