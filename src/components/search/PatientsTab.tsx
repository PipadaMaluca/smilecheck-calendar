...
function PatientCard({
  ...
  const isMobile = useIsMobile();
  return (
    <div className="bg-card border border-border rounded-xl p-4 space-y-2 cursor-pointer hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200" onClick={onViewDossier}>
